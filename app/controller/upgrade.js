...
const desejaUpgradeModel = require('../model/desejaUpgradeModel.js');
...
router.post('/usuario_deseja_upgrade/:algoritmo/:capital/:rentabilidade_aa', function(req, res, next) {
	POST = req.body;
	console.log('usuario deseja upgrade @@@@@@@@@@@@@@@@@@@@@@@@');
	console.log(POST);
	console.log('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@');
	...
	const desejoUsuario = new desejaUpgradeModel({
	...
	console.log('777777777777777777 desejoUsuario 7777777777777777');
	console.log(desejoUsuario);
	console.log('7777777777777777777777777777777777777777777777777');


	desejoUsuario.save(function(err,data_desejo_usuario){
		if (err) {
...
router.get('/relatorio/:algoritmo/:capital', function(req, res, next) {
	...
	console.log('estou no relatorio do upgrade');
