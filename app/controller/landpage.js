...
router.post('/enviar-formulario-conhecer-empresa', function(req, res, next) {
	POST = req.body;

	console.log('enviar-formulario-conhecer-empresa');
	console.log(POST);
	console.log('eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee');
	...
	const novo_contato = new contatoFormularioModel({ 						
		...
		telefone:POST.telefone,
		como_chegou:POST.como_chegou,
		responsavel_legal:POST.responsavel_legal,
		pretencao_investimento:pretencao_investimento,
		deletado:false,
		data_cadastro:new Date()
	});
	...
	if(pretencao_investimento == '100k'){
		...
		pretencao_investimento = 1000000;
	}else if(pretencao_investimento == '5m'){
		pretencao_investimento = 5000000;
	}else if(pretencao_investimento == '10m'){
		pretencao_investimento = 10000000;
	}else if(pretencao_investimento == '50m'){
		pretencao_investimento = 50000000;
	}else if(pretencao_investimento == '100m'){
...
router.post('/criar-usuario-empresa-redirecionar', function(req, res, next) {

	POST = req.body;

	console.log('cccccccccccccc criar-usuario-empresa-redirecionar ccccccccccccccccccccccccc');
	console.log(POST);
	console.log('cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc');
			...
			if(data_usuario.length == 0){
				...
				novo_usuario.save(function (err,usuario_retorno_save) {
					...
					if (err) {
						...
						var nome_algoritmo_escolhido = 'E-I ' + POST.algoritmo_show;

						const novo_status_usuario = new usuarioStatusModel({
							id_usuario:mongoose.Types.ObjectId(usuario_retorno_save._id),
							numero_operacoes:0,
							sistema_online:false,
							nome_algoritmo_escolhido:nome_algoritmo_escolhido,
							valor_aplicado:POST.capital,
							pagamento:true,
							conta:'Não Sincronizado',
							algoritmo:'Não Sincronizado',
...
router.post('/assinar_30dias_gratuitos_empresa/:algoritmo/:capital/:rentabilidade_aa/:algoritmo_show/:aluguel', function(req, res, next) {

	POST = req.body;

	console.log('--------------- assinar_30dias_gratuitos_empresa -----------------');
	console.log(POST);
	console.log('-----------------------------------------------------------');
	...
	var capital = req.params.capital;
	var rentabilidade_aa = req.params.rentabilidade_aa;
	var algoritmo_show = req.params.algoritmo_show;
	var aluguel = req.params.aluguel;
	...
	ultimosDadosContatoFormularioModel.findOne({email:POST.email_l},function(err,data_ultimo_contato){
		...
		if(data_ultimo_contato != null){
			...
			roboModel.findOne({valor:data_ultimo_contato.algoritmo},function(err,data_algoritmo){
				...
				if(data_ultimo_contato.tipo_usuario == 'empresa'){

					res.render(req.isAjaxRequest() == true ? 'api' : 'montadorLandpage', {html: 'landpage/parabens_container_empresa',  message: data});
				}else{
...
router.get('/carregar_formulario_pessoa_fisica', function(req, res, next) {
	console.log('fffffffffffffffffffffff');
	console.log('carregar_formulario_pessoa_fisica');
	console.log('fffffffffffffffffffffff');

	res.render(req.isAjaxRequest() == true ? 'api' : 'montadorLandpage', {html: 'landpage/formulario_container_pessoa_fisica',message: data});
});


router.get('/carregar_formulario_pessoa_juridica', function(req, res, next) {
	console.log('fffffffffffffffffffffff');
	console.log('carregar_formulario_pessoa_juridica');
	console.log('fffffffffffffffffffffff');

	res.render(req.isAjaxRequest() == true ? 'api' : 'montadorLandpage', {html: 'landpage/formulario_container_pessoa_juridica',message: data});
});

router.get('/carregar_formulario_empresa', function(req, res, next) {
	console.log('fffffffffffffffffffffff');
	console.log('carregar_formulario_empresa');
	console.log('fffffffffffffffffffffff');

	res.render(req.isAjaxRequest() == true ? 'api' : 'montadorLandpage', {html: 'landpage/formulario_empresa',message: data});
});


router.get('/carregar_formulario_banco', function(req, res, next) {
	console.log('fffffffffffffffffffffff');
	console.log('carregar_formulario_banco');
	console.log('fffffffffffffffffffffff');

	res.render(req.isAjaxRequest() == true ? 'api' : 'montadorLandpage', {html: 'landpage/formulario_banco',message: data});
});



router.get('/carregar_prosseguir_opcao_cliente', function(req, res, next) {

	console.log('carregar_prosseguir_opcao_cliente');
...
router.get('/carregar_escolha_algoritmo_gratis_menor_1_5kk', function(req, res, next) {

	console.log('carregar_escolha_algoritmo_gratis_menor_1_5kk');
	console.log('qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq');
	console.log('qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq');
	


	res.render(req.isAjaxRequest() == true ? 'api' : 'montadorLandpage', {html: 'landpage/function_barra_gratis',message: data});

});

router.get('/carregar_escolha_algoritmo_menor_1_5kk', function(req, res, next) {

	console.log('carregar_escolha_algoritmo_menor_1_5kk');
	console.log('qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq');
	console.log('qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq');
	


	res.render(req.isAjaxRequest() == true ? 'api' : 'montadorLandpage', {html: 'landpage/escolha_algoritmo',message: data});
...
router.get('/relatorio-pro/:algoritmo/:capital', function(req, res, next) {
	...
	roboModel.find({'valor':algoritmo},function(err,data_robo){
		...
		relatorioModel.find({},function(err,data_relatorio){
			...
			res.render(req.isAjaxRequest() == true ? 'api' : 'montadorLandpage', {html: 'landpage/simulador_open_pro', message: data});
...
router.get('/relatorio_empresa/:algoritmo/:capital/:multiplicador', function(req, res, next) {

	console.log('estou no relatorio_empresa');

	var algoritmo = req.params.algoritmo;
	var capital = req.params.capital;
	var multiplicador = req.params.multiplicador;
	...
	roboModel.find({'valor':algoritmo},function(err,data_robo){
		...
		relatorioModel.find({},function(err,data_relatorio){
			...
			for(i=0;i < data_relatorio[0].estrategias.length; i++){
				var net_profit = ((formCurrency.format(data_relatorio[0].estrategias[i].net_profit * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				console.log('net_profit: ' + net_profit);
				data_relatorio[0].estrategias[i].net_profit_exib_reais = net_profit;
				data_relatorio[0].estrategias[i].net_profit_exib_perc = transformar_porcentagem(data_relatorio[0].estrategias[i].net_profit * multiplicador,data_robo[0].multiplicador,capital);

				var drawdown = ((formCurrency.format(data_relatorio[0].estrategias[i].drawdown * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].estrategias[i].drawdown_exib_reais = drawdown;
				data_relatorio[0].estrategias[i].drawdown_exib_perc = transformar_porcentagem(data_relatorio[0].estrategias[i].drawdown * multiplicador,data_robo[0].multiplicador,capital);

				var average_trade = ((formCurrency.format(data_relatorio[0].estrategias[i].average_trade * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].estrategias[i].average_trade_exib_reais = average_trade;
				data_relatorio[0].estrategias[i].average_trade_exib_perc = transformar_porcentagem(data_relatorio[0].estrategias[i].average_trade * multiplicador,data_robo[0].multiplicador,capital);

				var year_average = ((formCurrency.format(data_relatorio[0].estrategias[i].year_average * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].estrategias[i].year_average_exib_reais = year_average;
				data_relatorio[0].estrategias[i].year_average_exib_perc = transformar_porcentagem(data_relatorio[0].estrategias[i].year_average * multiplicador,data_robo[0].multiplicador,capital);

				var daily_profit = ((formCurrency.format(data_relatorio[0].estrategias[i].daily_profit * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].estrategias[i].daily_profit_exib_reais = daily_profit;
				data_relatorio[0].estrategias[i].daily_profit_exib_perc = transformar_porcentagem(data_relatorio[0].estrategias[i].daily_profit * multiplicador,data_robo[0].multiplicador,capital);


				var month_profit = ((formCurrency.format(data_relatorio[0].estrategias[i].month_profit * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].estrategias[i].month_profit_exib_reais = month_profit;
				data_relatorio[0].estrategias[i].month_profit_exib_perc = transformar_porcentagem(data_relatorio[0].estrategias[i].month_profit * multiplicador,data_robo[0].multiplicador,capital);


				var average_trade = ((formCurrency.format(data_relatorio[0].estrategias[i].average_trade * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].estrategias[i].average_trade_exib = average_trade;
				data_relatorio[0].estrategias[i].average_trade_perc = transformar_porcentagem(data_relatorio[0].estrategias[i].average_trade * multiplicador,data_robo[0].multiplicador,capital);
			}

			for(i=0;i < data_relatorio[0].resume_performance.length; i++){
				var net_profit = ((formCurrency.format(data_relatorio[0].resume_performance[i].net_profit * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].resume_performance[i].net_profit_exib_reais = net_profit;
				data_relatorio[0].resume_performance[i].net_profit_exib_perc = transformar_porcentagem(data_relatorio[0].resume_performance[i].net_profit * multiplicador,data_robo[0].multiplicador,capital);

			}

			for(i=0;i < data_relatorio[0].monthly_performance.length; i++){

				var jan = ((formCurrency.format(data_relatorio[0].monthly_performance[i].jan * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].jan_exib_reais = jan;
				data_relatorio[0].monthly_performance[i].jan_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].jan * multiplicador,data_robo[0].multiplicador,capital);

				var fev = ((formCurrency.format(data_relatorio[0].monthly_performance[i].fev * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].fev_exib_reais = fev;
				data_relatorio[0].monthly_performance[i].fev_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].fev * multiplicador,data_robo[0].multiplicador,capital);

				var mar = ((formCurrency.format(data_relatorio[0].monthly_performance[i].mar * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].mar_exib_reais = mar;
				data_relatorio[0].monthly_performance[i].mar_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].mar * multiplicador,data_robo[0].multiplicador,capital);

				var apr = ((formCurrency.format(data_relatorio[0].monthly_performance[i].apr * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].apr_exib_reais = apr;
				data_relatorio[0].monthly_performance[i].apr_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].apr * multiplicador,data_robo[0].multiplicador,capital);

				var may = ((formCurrency.format(data_relatorio[0].monthly_performance[i].may * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].may_exib_reais = may;
				data_relatorio[0].monthly_performance[i].may_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].may * multiplicador,data_robo[0].multiplicador,capital);

				var jun = ((formCurrency.format(data_relatorio[0].monthly_performance[i].jun * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].jun_exib_reais = jun;
				data_relatorio[0].monthly_performance[i].jun_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].jun * multiplicador,data_robo[0].multiplicador,capital);

				var jul = ((formCurrency.format(data_relatorio[0].monthly_performance[i].jul * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].jul_exib_reais = jul;
				data_relatorio[0].monthly_performance[i].jul_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].jul * multiplicador,data_robo[0].multiplicador,capital);

				var aug = ((formCurrency.format(data_relatorio[0].monthly_performance[i].aug * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].aug_exib_reais = aug;
				data_relatorio[0].monthly_performance[i].aug_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].aug * multiplicador,data_robo[0].multiplicador,capital);

				var sep = ((formCurrency.format(data_relatorio[0].monthly_performance[i].sep * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].sep_exib_reais = sep;
				data_relatorio[0].monthly_performance[i].sep_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].sep * multiplicador,data_robo[0].multiplicador,capital);

				var oct = ((formCurrency.format(data_relatorio[0].monthly_performance[i].oct * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].oct_exib_reais = oct;
				data_relatorio[0].monthly_performance[i].oct_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].oct * multiplicador,data_robo[0].multiplicador,capital);

				var nov = ((formCurrency.format(data_relatorio[0].monthly_performance[i].nov * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].nov_exib_reais = nov;
				data_relatorio[0].monthly_performance[i].nov_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].nov * multiplicador,data_robo[0].multiplicador,capital);

				var dec = ((formCurrency.format(data_relatorio[0].monthly_performance[i].dec * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].dec_exib_reais = dec;
				data_relatorio[0].monthly_performance[i].dec_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].dec * multiplicador,data_robo[0].multiplicador,capital);

				var ytd = ((formCurrency.format(data_relatorio[0].monthly_performance[i].ytd * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].monthly_performance[i].ytd_exib_reais = ytd;
				data_relatorio[0].monthly_performance[i].ytd_exib_perc = transformar_porcentagem(data_relatorio[0].monthly_performance[i].ytd * multiplicador,data_robo[0].multiplicador,capital);

			}

			for(i=0;i < data_relatorio[0].stats.length; i++){
				var deviation = ((formCurrency.format(data_relatorio[0].stats[i].deviation * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].stats[i].deviation_exib_reais = deviation;
				data_relatorio[0].stats[i].deviation_exib_perc = transformar_porcentagem(data_relatorio[0].stats[i].deviation,data_robo[0].multiplicador * multiplicador,capital);

			}

			for(i=0;i < data_relatorio[0].trades.length; i++){
				var gross_profit = ((formCurrency.format(data_relatorio[0].trades[i].gross_profit * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].trades[i].gross_profit_exib_reais = gross_profit;
				data_relatorio[0].trades[i].gross_profit_exib_perc = transformar_porcentagem(data_relatorio[0].trades[i].gross_profit * multiplicador,data_robo[0].multiplicador,capital);

				var gross_loss = ((formCurrency.format(data_relatorio[0].trades[i].gross_loss * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].trades[i].gross_loss_exib_reais = gross_loss;
				data_relatorio[0].trades[i].gross_loss_exib_perc = transformar_porcentagem(data_relatorio[0].trades[i].gross_loss * multiplicador,data_robo[0].multiplicador,capital);

				var average_win = ((formCurrency.format(data_relatorio[0].trades[i].average_win * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].trades[i].average_win_exib_reais = average_win;
				data_relatorio[0].trades[i].average_win_exib_perc = transformar_porcentagem(data_relatorio[0].trades[i].average_win * multiplicador,data_robo[0].multiplicador,capital);

				var average_loss = ((formCurrency.format(data_relatorio[0].trades[i].average_loss * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].trades[i].average_loss_exib_reais = average_loss;
				data_relatorio[0].trades[i].average_loss_exib_perc = transformar_porcentagem(data_relatorio[0].trades[i].average_loss * multiplicador,data_robo[0].multiplicador,capital);

				var largest_win = ((formCurrency.format(data_relatorio[0].trades[i].largest_win * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].trades[i].largest_win_exib_reais = largest_win;
				data_relatorio[0].trades[i].largest_win_exib_perc = transformar_porcentagem(data_relatorio[0].trades[i].largest_win * multiplicador,data_robo[0].multiplicador,capital);

				var largest_loss = ((formCurrency.format(data_relatorio[0].trades[i].largest_loss * data_robo[0].multiplicador * multiplicador).replace('.','#')).replace(',','.')).replace('#',',');
				data_relatorio[0].trades[i].largest_loss_exib_reais = largest_loss;
				data_relatorio[0].trades[i].largest_loss_exib_perc = transformar_porcentagem(data_relatorio[0].trades[i].largest_loss * multiplicador,data_robo[0].multiplicador,capital);
